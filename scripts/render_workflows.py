...
from render_sdk import Workflow, Task
...
# Initialize Workflow
app = Workflow("sentientshield-workflows")
...
if __name__ == "__main__":
    # If run directly, process 7 sample logs to demonstrate
    sample_logs = [
    ...
    print("\n" + "="*50)
    print("SENTIENT SHIELD - LOG PROCESSING DEMO (7 LOGS)")
    print("="*50 + "\n")
    
    pipeline = get_pipeline()
    for i, log in enumerate(sample_logs, 1):
        print(f"[{i}/7] Processing: {log}")
    ...
    print("\nDemo complete. To run as a Render Workflow, deploy to Render.")
